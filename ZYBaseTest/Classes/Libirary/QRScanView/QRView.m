...
- (void)initView
{
    ...
    CGFloat scanW = kWidth(225);
    CGRect scanFrame = CGRectMake(width/2.-kWidth(112.5), height/4.-kWidth(112.5), scanW, scanW);
...
- (CGRect)rectOfInterestByScanViewRect:(CGRect)rect
{
    ...
    CGFloat x = rect.origin.y / viewRect.size.height;
    CGFloat y = rect.origin.x / viewRect.size.width;
    CGFloat w = rect.size.height / viewRect.size.height;
    CGFloat h = rect.size.width / viewRect.size.width;
