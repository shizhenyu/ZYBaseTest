...
- (id)initWithFrame:(CGRect)frame withPieChartTypeArray:(NSMutableArray *)pieChartTypeArray withPercentArray:(NSMutableArray *)percentArray withColorArray:(NSMutableArray *)colorArray
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        // 设置标题位置
        self.centerTitle = [[UILabel alloc]initWithFrame:CGRectMake((centerImageSize.width/2 - centerTitleWidth)/2, (centerImageSize.height/2 - 75)/2+5, centerTitleWidth, centerTitleHeight)];
