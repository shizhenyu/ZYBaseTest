//
//  ZYNavigationInteractiveTransition.m
//  ZYBaseTest
//
...
@interface ZYNavigationInteractiveTransition ()
...
@implementation ZYNavigationInteractiveTransition
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if (operation == UINavigationControllerOperationPop)
        ...
        return [[ZYPopAnimation alloc] init];
...
- (id<UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController interactionControllerForAnimationController:(id<UIViewControllerAnimatedTransitioning>)animationController {
    ...
    if ([animationController isKindOfClass:[ZYPopAnimation class]])
